...
# simulations (BISON solid mechanics simulation).
# Running this input requires MOOSE Reactor Module Objects
# Users should use
# --mesh-only HPMR_OneSixth_Core_meshgenerator_tri_hp_fine.e
...
[Mesh]
 ...
 [del_1]
  ...
  [rename_blocks]
    ...
    new_block = ' mod_ss moderator_quad moderator_tri hp_ss  heat_pipes_quad heat_pipes_tri fuel_quad fuel_tri outer_reflector_tri outer_reflector_quad monolith B4C air_gap_tri air_gap_quad air_gap_quad outer_reflector_tri  outer_reflector_quad outer_reflector_quad reflector_quad reflector_tri'
  ...
  [ctl]
    ...
    input = xysurf
    new_nodeset_name = 'centerline'
    expression = 'sqrt(x^2+y^2)<1e-6'
  []
[]