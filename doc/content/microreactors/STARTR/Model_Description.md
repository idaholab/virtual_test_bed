...
## Materials
The summary of all materials used in the model are listed below. The complex materials table includes materials with percent compositions of elements that can vary based on the psecifics of manufacturing. The materials in the simple table have defined integer chemical compositions.
...
where t is the temperature in degrees celcius [!citep](NaK1972). It is the only liquid material in the model, and thus experiences a density change significant enough to warrant inclusion of its temperature dependence.
