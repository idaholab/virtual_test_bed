...
The multigroup cross-section generation using MC$^2$-3 followed a two-step procedure and produced output in ISOTXS format. In the first step, a series of transport calculations were carried out using simple 0-D [GP_b_0D] or 1-D cylindrical models [Fu_st_1D] to obtain energy self-shielded cross sections over a fine energy grid  (> 1000 energy groups). The 1-D cylindrical model is also shown in [mc23_1D].
...
!media media/sefor/MC2-3-model.png
      ...
      id=mc23_1D
      caption= Mesh model of SEFOR Core I-E fuel assemblies: (a) Standard Assembly (SA), (b) SA with a GP rod and a B$_4$C rod, (c) SA with 2 GP rods, and (d) AFA
