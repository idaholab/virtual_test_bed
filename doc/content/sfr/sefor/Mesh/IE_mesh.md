...
!listing sfr/sefor/Mesh/Mesh_Core-I-E_3D_450K.i
         ...
         id=central_pin
         caption=MOOSE Reactor Module input for forming the central rod and its tightener.
...
!listing sfr/sefor/Mesh/Mesh_Core-I-E_3D_450K.i
         ...
         id=SA
         caption=MOOSE Reactor Module input for forming a standard fuel assembly.
...
!listing sfr/sefor/Mesh/Mesh_Core-I-E_3D_450K.i
         block=pattern_core
         id=Lattice
         caption=MOOSE Reactor Module input for forming the fuel core lattice from the assembly meshes.
...
!listing sfr/sefor/Mesh/Mesh_Core-I-E_3D_450K.i
         ...
         id=outer_boundary
         caption=MOOSE Reactor Module input for forming radial layers outside the fuel lattice.
...
!listing sfr/sefor/Mesh/Mesh_Core-I-E_3D_450K.i
         block=core_3d
         id=Mesh_model_3D
         caption=MOOSE Reactor Module input for extruding the 2D radial core into a 3D, assigning axial segments as needed.
