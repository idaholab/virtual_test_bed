...
!media media/htgr/3D_mhtgr/3d_mhtgr_meshes/fuel_pin.png
    style=width:45%
    caption=Figure 1: Fuel Pin Mesh

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/fuel_pin_mesh
...
!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/burnable_poison_pin_mesh
...
!media media/htgr/3D_mhtgr/3d_mhtgr_meshes/fuel_assembly.png
    style=width:45%
    caption=Figure 2: Fuel Assembly Mesh without RSC Channel

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/fuel_assembly
...
!media media/htgr/3D_mhtgr/3d_mhtgr_meshes/fuel_assembly_with_rsc.png
    style=width:45%
...
!media media/htgr/3D_mhtgr/3d_mhtgr_meshes/fuel_assembly_with_rsc_variations.png
    style=width:85%
    caption=Figure 4: Fuel Assembly Mesh Variations

The following code is repeated for each transformation.

!listing htgr/3D_mhtgr/3D_mhtgr_final.i start=[fuel_assembly_with_rsc_1] end=[fuel_assembly_w_rsc_0]
...
!listing htgr/3D_mhtgr/3D_mhtgr_final.i start=[transform_reflector_assembly_1_2_3] end=[reflector_assembly_1_2_3]
...
!media media/htgr/3D_mhtgr/3d_mhtgr_meshes/reflector_assembly_0_1.png
    style=width:45%
...
!listing htgr/3D_mhtgr/3D_mhtgr_final.i start=[reflector_assembly_w_cr_base_0_1] end=[reflector_assembly_w_cr_hole_0_1]

The following code is repeated for each of the 12 permutations.

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/transform_reflector_assembly_w_cr_hole_0_1_reflected
...
!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/reflector_assembly_w_cr_base_0

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/delete_reflector_assembly_interior_w_cr_0

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/rebuild_reflector_assembly_interior_w_cr_0

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/remesh_reflector_assembly_interior_w_cr_0

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/triangulate_reflector_assembly_w_cr_hole_0

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/stitch_reflector_assembly_w_cr_hole_0

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/fill_reflector_assembly_cr_hole_0

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/stitch_reflector_assembly_cr_hole_filled_0

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/reflector_assembly_w_cr_hole_0

The following code is repeated for each of the 6 permutations.

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/transform_reflector_assembly_w_cr_hole_1

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/reflector_assembly_w_cr_hole_1
...
!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/extrude

The blocks are renamed for convenience, and then element and depletion ids are assigned.

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/add_plane_id

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/rename_blocks

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/add_material_id

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/add_depletion_id
...
!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/coarse_mesh_hex_meta

!listing htgr/3D_mhtgr/3D_mhtgr_final.i block=Mesh/coarse_hex_core
