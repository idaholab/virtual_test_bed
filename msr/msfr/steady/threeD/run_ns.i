...
Sc_t = 10 # turbulent Schmidt number
...
[Mesh]
  ...
  [rename]
    ...
    input = hx_bot
    old_block = "MSFR Pump HX"
    new_block = "fuel pump hx"
  []
  [new_wall]
    type = ParsedGenerateSideset
    input = rename
    included_boundaries = 'Wall'
    new_sideset_name = "Wall_2"
    combinatorial_geometry = 'x>-1e1000'
  []
...
[Modules]
  [NavierStokesFV]
    ...
    # Boundary conditions
    wall_boundaries = 'Wall_2 Symmetry'
