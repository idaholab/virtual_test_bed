...
# A heated solution, with a cosine power distribution, can be generated with
...
[Transfers]
  ...
  # Velocity transfers, from fluid flow to temperature advection
  [v_x_to_temperature]
    type = MultiAppProjectionTransfer
    multi_app = temperature
    direction = to_multiapp
