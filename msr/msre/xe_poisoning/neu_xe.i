...
# ==============================================================================
[GlobalParams]
  library_file = './mgxs/xs_msre_micro_xe.xml'
  library_name = 'xs_msre_micro_xe'
  is_meter = true
[]
# ==============================================================================
# TRANSPORT SYSTEM
...
[TransportSystems]
  ...
  VacuumBoundary = 'bottom loop_boundary right top top_core_barrel bypass_line_boundary extraction return_line_boundary'
  [transport]
...
[AuxKernels]
  ...
  [update_ad_f_U235]
    type = ParsedAux
    block = 'lower_plenum upper_plenum down_comer riser pump elbow bypass_line strip return_line'
    variable = ad_U235
...
[Postprocessors]
  ...
  [Leakage]
    ...
    boundary = 'right bottom loop_boundary pump_outlet downcomer_inlet top_core_barrel bypass_line_boundary extraction return_line_boundary'
    transport_system = transport
  []
[]
