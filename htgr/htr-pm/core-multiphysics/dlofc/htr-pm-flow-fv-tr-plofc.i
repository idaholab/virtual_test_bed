...
# Model description
# ------------------------------------------------------------------------------
# PLOFC HTR-PM model Created & modifed by Sebastian Schunert, Mustafa Jaradat September 29, 2022
# ==============================================================================
...
[Functions]
  ...
  [pressure_out_fn]
    type = PiecewiseLinear
    x = '  0           13'
    y = '${p_outlet} ${fparse 2/3 * p_outlet}'
  []
  [dt_max_fn]
    type = PiecewiseLinear
    x = '-10 0 16 30 1000 5000 20000'
    y = '  1 1 1  1  100  1000 3600 '
  []
[]
