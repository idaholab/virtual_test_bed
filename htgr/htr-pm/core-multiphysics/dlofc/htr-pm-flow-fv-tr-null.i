...
# Model description
# ------------------------------------------------------------------------------
# NULL HTR-PM model Created & modifed by Sebastian Schunert, Mustafa Jaradat September 29, 2022
# ==============================================================================
...
[Mesh]
  [file]
    ...
    file = '../equilibrium_core/htr_pm_griffin_ss_out_flow0.e'
...
[Functions]
  ...
  [pressure_out_fn]
    type = PiecewiseLinear
    x = '          0            13          1e+7'
    y = '${p_outlet}   ${p_outlet}   ${p_outlet}'
  []
  [dt_max_fn]
    type = PiecewiseLinear
    x = '-10 0 16 30 1000 5000 20000 600000'
    y = '  1 1 1  1  100  1000 3600 3600'
  []
[]
...
[Postprocessors]
  ...
  [rpv_radiation_out] # should be equal to 0 upon convergence
    type = ParsedPostprocessor
    function = '0.8*5.6703e-8*316.6725395*(right_Temp^4 - 343.15^4)/1000.0'
    pp_names = 'right_Temp'
  []
  [rpv_convective_out]
    type = ParsedPostprocessor
    function = '1.0*316.6725395*(right_Temp - 343.15)/1000.0'
    pp_names = 'right_Temp'
    execute_on = 'TIMESTEP_END'
  []
