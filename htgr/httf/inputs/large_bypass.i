# Models the large bypass channels for the HTTF PG-26 Transient
# Application: RELAP-7
# POC: Thomas Freyman, thomas.freyman at inl.gov
# If using or referring to this model, please cite as explained in
# https://mooseframework.inl.gov/virtual_test_bed/citing.html

# Model of the 1.9 cm diameter (large) bypass channels
T_in = 373.15 # K
p_out = 225000 # Pa
...
[Functions]
  ...
  [system_pressure]
    ...
    format = columns
  []
  # Creates a function which calculates the inlet mass flowrate of a single large bypass channel
  [mdot_in_fn]
    type = ParsedFunction
    expression = '${fparse (m_dot_total*(A_lb/A_total))/n_large_bypass}'
    symbol_names = 'm_dot_total A_lb A_total n_large_bypass'
    symbol_values = '${m_dot_total} ${A_lb} ${A_total} ${n_large_bypass}'
  []
[]
...
[Components]
  # Inlet which initializes the large bypass channel based on an inlet temperature and mass flow rate
  [channel_inlet]
