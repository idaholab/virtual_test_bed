# Models the medium coolant channels for the HTTF PG-26 Transient
# Application: RELAP-7
...
[Functions]
  ...
  [mdot_in_fn]
    type = ParsedFunction
    expression = '${fparse (m_dot_total*(A_m/A_total))/n_medium_channels}'
    symbol_names = 'm_dot_total A_m A_total n_medium_channels'
    symbol_values = '${m_dot_total} ${A_m} ${A_total} ${n_medium_channels}'
  []
[]
