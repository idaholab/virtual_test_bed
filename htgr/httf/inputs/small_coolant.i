# Models the small flow channels for the HTTF PG-26 Transient
# Application: RELAP-7
# POC: Thomas Freyman, thomas.freyman at inl.gov
# If using or referring to this model, please cite as explained in
# https://mooseframework.inl.gov/virtual_test_bed/citing.html

# Model of the 1 cm diameter (small) flow channels
T_in = 373.15 # K
p_out = 225000 # Pa
...
m_dot_in = ${fparse (m_dot_total*(A_s/A_total))/n_small_channels}
R_He = 2076.9 # J/kg-K
...
[Functions]
  ...
  [system_pressure]
    ...
    format = columns
  []
  # Creates a function which calculates the inlet mass flowrate of a single small flow channel
  [mdot_in_fn]
    type = ParsedFunction
    expression = '${fparse (m_dot_total*(A_s/A_total))/n_small_channels}'
    symbol_names = 'm_dot_total A_s A_total n_small_channels'
    symbol_values = '${m_dot_total} ${A_s} ${A_total} ${n_small_channels}'
  []
[]
...
[Components]
  # Inlet which initializes the small flow channel based on an inlet temperature and mass flow rate
  [channel_inlet]
