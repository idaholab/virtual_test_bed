# Models the small bypass channels for the HTTF PG-26 Transient
# Application: RELAP-7
# POC: Thomas Freyman, thomas.freyman at inl.gov
# If using or referring to this model, please cite as explained in
# https://mooseframework.inl.gov/virtual_test_bed/citing.html

# Model of the 1.6 cm diameter (small) bypass channels
T_in = 373.15 # K
p_out = 225000 # Pa
...
m_dot_in = ${fparse (m_dot_total*(A_sb/A_total))/n_small_bypass} # kg/s
R_He = 2076.9 # J/kg-K
...
[Components]
  # Inlet which initializes the small bypass channel based on an inlet temperature and mass flow rate
  [channel_inlet]
