...
[Mesh]
  ...
  block_name = 'pebble_bed cavity bottom_reflector side_reflector bottom_plenum upper_plenum riser'
  ...
  # Riser outer wall (right face of block 7)
  [riser_right]
    type = SideSetsAroundSubdomainGenerator
    input = br_bp_baffle
    block = 7
  ...
  # Riser inner wall (left face of block 7, adjacent to side_reflector)
  [riser_left]
  ...
  [RenameBoundaryGenerator]
    ...
    old_boundary = ' left_to_1 left_to_2 left_to_3 left_to_4 left_to_5 side_reflector_bed side_reflector_bottom_reflector bottom_plenum_bottom bottom_plenum_top cavity_top       upper_plenum_top upper_plenum_bottom riser_left  riser_right riser_top'
    new_boundary = '     bed_left  bed_left  bed_left  bed_left  bed_left  bed_right          bed_right                      horizontal_walls    horizontal_walls horizontal_walls horizontal_walls horizontal_walls riser_walls riser_walls horizontal_walls'
  []
...
[UserObjects]
  [rc]
    ...
    pressure_baffle_sidesets = 'baffle_cav_bed baffle_cav_up bed_br_baffle up_riser_baffle br_bp_baffle'
    pressure_baffle_relaxation = 1.0

    reconstructed_pressure_gradient_feedback_relaxation = 1.0
    pressure_projection_method = consistent

    block = 'pebble_bed cavity bottom_reflector bottom_plenum upper_plenum riser'
...
[Variables]
  ...
  [T_solid]
    ...
    block = 'pebble_bed bottom_reflector side_reflector bottom_plenum upper_plenum riser'
  []
[]
...
[FunctorMaterials]
  ...
  [kappa_f_mat_no_pebble_bed]
    ...
    prop_names = 'kappa'
    prop_values = 'k k k'
    block = 'cavity bottom_reflector bottom_plenum upper_plenum riser'
  []
