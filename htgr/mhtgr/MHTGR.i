...
[Executioner]
  ...
  [./TimeStepper]
    type = FunctionDT
#    time_t = ' 0    0.1   1     60    120  200   600   3000 6000  1e5  1e6 '
#    time_dt =' 0.01 0.02 0.05  0.05  0.1  0.5   1     10    20    50  200'

    time_t = ' -500e3   -499999.9   -499999  -499998   -499940  -499600      -494000  0 '
    time_dt =' 0.005       0.1        0.3      1           20        50        100     1000'
